  ...
  return (
    <section className="w-full min-h-screen bg-white py-12">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-20">HEADLINES</h2>
        <Swiper
          ...
          loopFillGroupWithBlank={true} // Menambahkan slide tambahan untuk loop
          coverflowEffect={{
            rotate: 0,
            stretch: 0,
            depth: 200,
        ...
        >
          {headlines.map((headline, index) => (
            <SwiperSlide key={index}>
              <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md transform transition-transform duration-300 hover:scale-105">
                <img
                  src={headline.image}
                  alt={headline.title}
